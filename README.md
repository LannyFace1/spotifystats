...
![Screenshot](<img width="1852" height="796" alt="Screenshot 2026-02-28 133430" src="https://github.com/user-attachments/assets/1de3bdfc-8775-4f39-927c-0d9e0955e907" />)
...
```nginx
# Traefik oder Nginx — SpotifyStats auf Port 3000
...
# Backup MongoDB
docker exec spotifystats_mongo mongodump --out /tmp/backup
docker cp spotifystats_mongo:/tmp/backup ./backup
```
